...
#     --output_embed_path "/home/zhengbaj/tir5/zhiqing/data/dataset_embed/llama-2-13b_medqa_v4.h5" \
#     --prompt_style "v4" \
#     --eval_batch_size 16
...
python -u generate_medqa_vector.py \
    ...
    --data_path "/home/zhengbaj/tir5/zhiqing/data/dataset_medqa/medqa_test.json" \
    --output_embed_path "/home/zhengbaj/tir5/zhiqing/data/dataset_embed/llama-2-70b_medqa_v3.h5" \
    --prompt_style "v3" \
    --eval_batch_size 8
